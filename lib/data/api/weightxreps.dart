...
class CommunityApi{
  ...
  Future<List<Summary>> fetchSummary() async {
    final response = await http.get('https://api.apify.com/v1/W34JM2HMA6L2cMsrg/crawlers/n444LBxiSGYKHKn3P/lastExec/results?token=' + APIFY_KEY);
  ...
  Future<bool> login(String user, String pass) async {
    ...
    final response = await http.post('https://api.apify.com/v1/W34JM2HMA6L2cMsrg/crawlers/6Wz4ADJFYhjrLhY5b/execute?token=' + APIFY_KEY + "&wait=120", headers: headers, body: jsonEncode(body));
